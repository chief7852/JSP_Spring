...
public class BoardReadController {
	...
	public String boardAuth(@RequestParam("bo_no") int bo_no, @RequestParam("bo_pass") String bo_pass,
			HttpSession session) {
	...
	public String view(@RequestParam("what") int bo_no,
	...
	@ResponseBody
	public String preview(@RequestParam("what") int bo_no, @ModelAttribute("search") BoardVO search
	/*
...
//			service.upHit(board);
	...
	public PagingVO<BoardVO> noticeListForAjax(@RequestParam(value = "searchType", required = false) String searchType,
		...
		searchType = "type";
		searchWord = "NOTICE";
		return listForAjax(currentPage, searchType, searchWord, minDate, maxDate);
	}

	@RequestMapping("/board/noticeList.do")
	public String noticeList(@RequestParam(value = "searchType", required = false) String searchType,
			@RequestParam(value = "searchWord", required = false) String searchWord,
			@RequestParam(value = "page", required = false, defaultValue = "1") int currentPage,
			@RequestParam(value = "minDate", required = false) String minDate,
			@RequestParam(value = "maxDate", required = false) String maxDate
		...
		searchType = "type";
		searchWord = "NOTICE";
		return listForHTML(currentPage, searchType, searchWord, minDate, maxDate, model);
	}

	@RequestMapping(value = { "/board/boardList.do", "/board/noticeList.do" })
