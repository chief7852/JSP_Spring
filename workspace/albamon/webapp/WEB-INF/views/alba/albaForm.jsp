...
<form method="post" name="alba">
	<table class="table table-bordered table-dark">
		...
		<tr class="form-group col-md-6">
			<th scope="row">이름</th>
			<td><input name="al_name" type="text" class="form-control"></td>
		</tr>
		<tr class="form-group col-md-6">
			<th scope="row">나이</th>
			<td><input name="al_name" type="text" class="form-control"></td>
		...
		<tr class="form-group col-md-6">
			<th scope="row">주소</th>
			<td><input id="sample2_address" readonly="readonly" type="text" class="form-control"></td>
		</tr>
		<tr class="form-group col-md-6">
			<th scope="row">상세주소</th>
			<td><input id="sample2_detailAddress" type="text"
				class="form-control" id=></td>
		</tr>
		<!-- <tr class="form-group col-md-6">
  	<th scope="row">참고항목</th>
  	<td><input id="sample2_extraAddress" type="text" class="form-control" ></td>
  </tr> -->
