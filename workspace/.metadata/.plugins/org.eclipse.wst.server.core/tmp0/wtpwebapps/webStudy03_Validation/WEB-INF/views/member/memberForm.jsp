		...
		<c:if test='${"update" ne command }'>
			...
			<tr>
				...
				<td><input type="text" name="mem_id" 
					value="${member.mem_id }" />
					<span class="error">${error.mem_id }</span>
			...
			<tr>
				...
				<span class="error">${errors["prod_pass"]}</span></td>
			</tr>
			<tr>
				<th>이름</th>
