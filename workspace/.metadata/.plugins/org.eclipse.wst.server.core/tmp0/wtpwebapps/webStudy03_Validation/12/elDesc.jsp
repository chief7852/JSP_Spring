...
<pre>
	: 데이터를 표현(출력 ) 할 목적으로 정의된 스크립트 언어
	
	기능
	1. 4개의 영역의 속성들을 표현할 때 사용(******).
	2. 연산자 지원
	       산술연산자
	        : +-*/% ${2/3}(0.6666),${"2"+"3"}(5),${"2"+3 }(5),	//( EL에서는 +는 무조건 산술연산(문자열안됨))(정수연산을 하지않고 실수연산을함)
	 ...
	 \${sampleList.get(0) } , ${applicationScope.sampleList[0] },${sampleList[3] }
