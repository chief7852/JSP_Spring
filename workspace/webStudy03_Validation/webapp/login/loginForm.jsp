...
<body>
	...
	<form action="<%=request.getContextPath()%>/login/loginCheck.do"
		...
		<input type="text" name="mem_id" placeholder="아이디"
			value="<%=Objects.toString(idCookie, "")%>" /> <input type="text"
			name="mem_pass" placeholder="비밀번호" /> <input type="checkbox"
			name="saveId" value="saveId" <%=idCookie != null ? "checked" : ""%>>아이디기억하기
