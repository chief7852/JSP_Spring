			...
			<td>
				...
				<c:if test="${not empty board.attatchList }">
					...
					<div class="form-inline fileArea">
						<p><span class="form-control">${attatch.att_filename }</span>
						<button type="button" class="btn btn-danger" value="${attatch.att_no }">x</button></p>
					</div>
					</c:forEach>
				</c:if>
...
<script type="text/javascript">
	...
	$(".btn-danger").on('click',function(){
		let test = $(this).val();
		$("#sub").append("<input type='text' name='delAttNos' value='"+test+"'>")
