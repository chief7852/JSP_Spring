 ...
 * 		- unchecked exception : RuntiomeException 직계
 ...
 * 
 * ++ custom 예외 정의 방법
 * 	: 상위(예외의 특성에따라 Exception/RuntimeException)에 예외 클래스를 상속
 */
...
//		}
	...
	private static String method2(){
		...
		try {
			if(1==1)
	//		throw new IllegalArgumentException("강제발생 예외");
	...
	private static String method1() throws IOException {
		try {
			...
			System.err.println("에외발생"+e.getMessage());
			throw e;
		}
